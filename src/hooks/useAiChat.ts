...
// o agente Gemini, com contexto do terminal
// Terminal-AI | Fase 3
// ─────────────────────────────────────────────

import { useState, useRef, useCallback } from "react";
import { aiChat, getAiStatus } from "../services/api";
import type { ChatMessage, AiStatusResponse, ShellInfo } from "../types";
...
export function useAiChat(
  ...
  }, [messages, isLoading, currentShell, promptRef]);
